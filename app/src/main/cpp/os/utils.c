...
#include "../x11/headers/input.h"
#include "../x11/headers/dixfont.h"
#include "../x11/headers/fonts/libxfont2.h"
#include "osdep.h"
#include "../x11/headers/extension.h"
#include <signal.h>
#ifndef WIN32
#include <sys/wait.h>
#endif
...
#include "../x11/headers/picture.h"

#include "../x11/mi/miinitext.h"
 ...
 */
#define LOCK_DIR AWIMUL_FILES_PATH"/tmp"
...
LockServer(void)
{
    ...
    while ((!haslock) && (i++ < 3)) {
        ...
        if (haslock) {
            ...
            unlink(tmp);
            FatalError
                    ("Linking lock file (%s) in place failed: %s %d\n",
