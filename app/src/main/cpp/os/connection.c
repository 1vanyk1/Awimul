...
#include "../x11/headers/xproto.h"
#define TRANS_SERVER
#define TRANS_REOPEN
#include "../x11/headers/Xtrans/Xtrans.h"
#include "../x11/headers/Xtrans/Xtransint.h"
#include <errno.h>
#include <signal.h>
#include <stdio.h>
#include <stdlib.h>
...
#endif                          /* WIN32 */
#include "../x11/headers/misc.h"               /* for typedef of pointer */
#include "osdep.h"
#include "../x11/headers/opaque.h"
#include "../x11/headers/dixstruct.h"
#include "../x11/xext/xace.h"
