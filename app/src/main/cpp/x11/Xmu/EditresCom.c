...
#include <config.h>
#endif
#include "../libXt/IntrinsicP.h"	/* To get into the composite and core widget
				   structures. */
#include "../libXt/ObjectP.h"	/* For XtIs<Classname> macros. */
#include "../libXt/StringDefs.h"	/* for XtRString. */
#include "../libXt/ShellP.h"		/* for Application Shell Widget class. */

#include "../headers/xatom.h"
#include "../headers/xos.h"		/* for strcpy declaration */
