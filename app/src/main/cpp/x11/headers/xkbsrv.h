...
#define WRAP_PROCESS_INPUT_PROC(device, oldprocs, proc, unwrapproc) \
	device->_public.processInputProc = proc; \
	oldprocs->processInputProc = \
	oldprocs->realInputProc = device->_public.realInputProc; \
	device->_public.realInputProc = proc; \
	oldprocs->unwrapProc = device->unwrapProc; \
	device->unwrapProc = unwrapproc;

#define COND_WRAP_PROCESS_INPUT_PROC(device, oldprocs, proc, unwrapproc) \
	if (device->_public.processInputProc == device->_public.realInputProc)\
	    device->_public.processInputProc = proc; \
	oldprocs->processInputProc = \
	oldprocs->realInputProc = device->_public.realInputProc; \
	device->_public.realInputProc = proc; \
...
#define UNWRAP_PROCESS_INPUT_PROC(device, oldprocs, backupproc) \
        backupproc = device->_public.realInputProc; \
	if (device->_public.processInputProc == device->_public.realInputProc)\
	    device->_public.processInputProc = oldprocs->realInputProc; \
	device->_public.realInputProc = oldprocs->realInputProc; \
