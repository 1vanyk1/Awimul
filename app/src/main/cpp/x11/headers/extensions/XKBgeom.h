...
extern Status
        XkbAllocGeomSections2(
        XkbGeometryPtr	/* geom */,
        int			/* nSections */
);

extern Status
XkbAllocGeomOverlays2(
        XkbSectionPtr	/* section */,
        int			/* num_needed */
);

extern Status
XkbAllocGeomOverlayRows2(
        XkbOverlayPtr	/* overlay */,
        int			/* num_needed */
);

extern Status
XkbAllocGeomOverlayKeys2(
        XkbOverlayRowPtr	/* row */,
        int			/* num_needed */
);
...
extern Status
XkbAllocGeomSectionDoodads2(
        XkbSectionPtr	/* section */,
        int			/* nDoodads */
);

extern Status
XkbAllocGeomOutlines2(
        XkbShapePtr		/* shape */,
        int			/* nOL */
);
