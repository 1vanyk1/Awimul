...
#include "../libXt/ShellP.h"
#include "../libXt/VendorP.h"
#include "../Xmu/Converters.h"
#include "../Xmu/Atoms.h"
#include "../Xmu/Editres.h"
#include "../Xmu/ExtAgent.h"
...
externaldef(vendorshellclassrec) VendorShellClassRec vendorShellClassRec_Xaw = {
        {
...
externaldef(vendorshellwidgetclass) WidgetClass vendorShellWidgetClass =
        (WidgetClass) (&vendorShellClassRec_Xaw);
#endif
