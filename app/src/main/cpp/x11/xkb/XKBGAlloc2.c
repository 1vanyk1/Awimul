...
#include "XKBlibint.h"
#include "../headers/extensions/XKBgeom.h"
#include "../headers/extensions/XKBproto.h"
...
void
XkbFreeGeomOverlayKeys2(XkbOverlayRowPtr row, int first, int count, Bool freeAll)
{
    _XkbFreeGeomLeafElems(freeAll, first, count,
...
_XkbClearOverlayRow(char *row_in)
{
    ...
    if (row->keys != NULL)
        XkbFreeGeomOverlayKeys2(row, 0, row->num_keys, True);
    return;
}
...
Status
XkbAllocGeomProps2(XkbGeometryPtr geom, int nProps)
{
    return _XkbAllocProps(geom, nProps);
}

Status
XkbAllocGeomColors2(XkbGeometryPtr geom, int nColors)
{
    return _XkbAllocColors(geom, nColors);
}

Status
XkbAllocGeomKeyAliases2(XkbGeometryPtr geom, int nKeyAliases)
{
    return _XkbAllocKeyAliases(geom, nKeyAliases);
}

Status
XkbAllocGeomShapes2(XkbGeometryPtr geom, int nShapes)
{
    return _XkbAllocShapes(geom, nShapes);
}

Status
XkbAllocGeomSections2(XkbGeometryPtr geom, int nSections)
{
    return _XkbAllocSections(geom, nSections);
}

Status
XkbAllocGeomOverlays2(XkbSectionPtr section, int nOverlays)
{
    return _XkbAllocOverlays(section, nOverlays);
}

Status
XkbAllocGeomOverlayRows2(XkbOverlayPtr overlay, int nRows)
{
    return _XkbAllocOverlayRows(overlay, nRows);
}

Status
XkbAllocGeomOverlayKeys2(XkbOverlayRowPtr row, int nKeys)
{
    return _XkbAllocOverlayKeys(row, nKeys);
}

Status
XkbAllocGeomDoodads2(XkbGeometryPtr geom, int nDoodads)
{
    return _XkbAllocDoodads(geom, nDoodads);
}

Status
XkbAllocGeomSectionDoodads2(XkbSectionPtr section, int nDoodads)
{
    return _XkbAllocDoodads(section, nDoodads);
}

Status
XkbAllocGeomOutlines2(XkbShapePtr shape, int nOL)
{
    return _XkbAllocOutlines(shape, nOL);
}

Status
XkbAllocGeomRows2(XkbSectionPtr section, int nRows)
{
    return _XkbAllocRows(section, nRows);
}

Status
XkbAllocGeomPoints2(XkbOutlinePtr ol, int nPts)
{
    return _XkbAllocPoints(ol, nPts);
}

Status
XkbAllocGeomKeys2(XkbRowPtr row, int nKeys)
{
