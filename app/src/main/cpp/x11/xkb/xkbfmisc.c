                          ...
                          XkbDescPtr xkb, unsigned want, unsigned need)
{
    ...
    if (wantConfig & XkmKeyNamesMask)
        XkbWriteXKBKeycodes2(file, xkb, FALSE, FALSE, _AddIncl, names->keycodes);
    ...
    if (wantConfig & XkmTypesMask)
        XkbWriteXKBKeyTypes2(file, xkb, FALSE, FALSE, _AddIncl, names->types);
    ...
    if (wantConfig & XkmCompatMapMask)
        XkbWriteXKBCompatMap2(file, xkb, FALSE, FALSE, _AddIncl, names->compat);
    ...
    if (wantConfig & XkmSymbolsMask)
        XkbWriteXKBSymbols2(file, xkb, FALSE, FALSE, _AddIncl, names->symbols);
    else if (wantNames & XkmSymbolsMask)
        XkbWriteSectionFromName(file, "symbols", names->symbols);

    if (wantConfig & XkmGeometryMask)
        XkbWriteXKBGeometry2(file, xkb, FALSE, FALSE, _AddIncl, names->geometry);
