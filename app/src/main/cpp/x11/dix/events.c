...
#ifdef PANORAMIX
#include "../headers/panoramiX.h"
#include "../headers/panoramiXsrv.h"
#endif
...
#include "../xext/geint.h"

#include "../headers/eventstr.h"
#include "../headers/enterleave.h"
#include "../headers/eventconvert.h"
#include "../mi/mi.h"
...
#endif
            (*qe->device->_public.processInputProc) (qe->event, qe->device);
            free(qe);
...
FreezeThaw(DeviceIntPtr dev, Bool frozen)
{
    ...
    if (frozen)
        dev->_public.processInputProc = dev->_public.enqueueInputProc;
    else
    dev->_public.processInputProc = dev->_public.realInputProc;
}
