...
#include "../xi/xiquerydevice.h"      /* for SizeDeviceClasses */
#include "../xi/xiproperty.h"
#include "../headers/enterleave.h"         /* for EnterWindow() */
#include "../headers/xserver-properties.h"
#include "../xi/xichangehierarchy.h"  /* For XISendDeviceHierarchyEvent */
#include "../xext/syncsrv.h"
#include "../../main_wm.h"
...
AddInputDevice(ClientPtr client, DeviceProc deviceProc, Bool autoStart)
{
    ...
    dev->id = devid;
    dev->_public.processInputProc = ProcessOtherEvent;
    dev->_public.realInputProc = ProcessOtherEvent;
    dev->_public.enqueueInputProc = EnqueueEvent;
                ...
                DeviceProc ptr_proc, DeviceProc keybd_proc, Bool master)
{
    ...
    *ptr = *keybd = NULL;
    ...
    pointer->_public.processInputProc = ProcessOtherEvent;
    pointer->_public.realInputProc = ProcessOtherEvent;
    ...
    keyboard->_public.processInputProc = ProcessOtherEvent;
    keyboard->_public.realInputProc = ProcessOtherEvent;
...
DeliverDeviceClassesChangedEvent(int sourceid, Time time)
{
    ...
    if (num_events) {
        ...
        dev->_public.processInputProc(&dcce, dev);
    }
}
