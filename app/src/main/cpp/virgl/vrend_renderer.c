...
#include "gallium/auxiliary/util/u_inlines.h"
#include "mesa/util/u_memory.h"
#include "gallium/auxiliary/util/u_dual_blend.h"

#include "mesa/util/u_thread.h"
#include "gallium/auxiliary/util/u_format.h"
#include "gallium/auxiliary/tgsi/tgsi_parse.h"
...
#include "gallium/auxiliary/tgsi/tgsi_text.h"
